...
login_frame = ttk.Frame(root, padding=20, width=700, height=450)
login_frame.place(relx=0.5, rely=0.3, anchor="center")  # Center the frame

# Add a title label
title_label = ttk.Label(login_frame, text="Health", font=("Helvetica", 18, "bold"))
