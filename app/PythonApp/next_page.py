...
def open_next_page(username, root):
    ...
    next_page_window.configure(bg="#A9D6B2")  # Fundal deschis pentru pagina următoare

    # Mesaj de bun venit cu numele utilizatorului
    welcome_message = f"Welcome {username}!\nYou are successfully logged in!"
    welcome_label = ttk.Label(next_page_window, text=welcome_message, font=("Helvetica", 20, "bold"), background="#A9D6B2")
